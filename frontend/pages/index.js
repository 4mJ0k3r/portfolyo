  ...
  return (
    <div className="bg-gray-50">
        ...
        >
          <div className="relative z-10 flex flex-col items-center text-center w-full px-2">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a 
                href="/register"
                className="bg-blue-500 hover:bg-blue-700 text-white font-semibold px-6 py-2 rounded-md transition"
              >
                Create Profile
              </a>
              <a 
                href="/login"
                className="bg-white hover:bg-gray-100 text-gray-900 font-semibold px-6 py-2 rounded-md transition"
              >
                Browse Talent
              </a>
            </div>
      ...
      <section className="max-w-2xl mx-auto px-4 py-12 text-center">
        ...
        <a 
          href="/register"
          className="bg-blue-500 hover:bg-blue-700 text-white font-semibold px-6 py-3 rounded-md transition"
        >
          Create Your Profile
        </a>
      </section>
